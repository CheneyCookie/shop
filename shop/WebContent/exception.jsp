...
<meta http-equiv=refresh content=3;url=//localhost:8888/shop />
<style type=text/css>
.font14 {
	font-size: 14px
}
...
<body>
	<table height=500 cellSpacing=0 cellPadding=0 width=500 align=center
		background=${shop }/image/exception.gif border=0>
		<tbody>
			<tr>
				<td height=330></td>
			</tr>
			<tr>
				<td vAlign=top>
					<div class=font14 align=center>
						...
						<font color=#666666>三秒后自动返回<a href="//localhost:8080/shop">易购商城</a>首页........ 
					</div>
				</td>
			</tr>
		</tbody>
