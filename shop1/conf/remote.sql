/*删除商城数据库,如果存在*/
drop database if exists sq_cheney;
/*创建数据库,并设置编码*/
create database sq_cheney default character set utf8;
...
/* 修改自动增长的初始值 */
ALTER TABLE shop_forder AUTO_INCREMENT = 2013021801;

/*=============================*/
/* Table: 购物项表结构 		   */
/*=============================*/

create table shop_sorder
(
   /* 购物项编号,自动增长 */
   id                  int not null auto_increment,
   /* 被购买商品的名称 */
...
/*插入测试用例*/
INSERT INTO shop_account(login,name,password) values ('admin','管理员','admin');
INSERT INTO shop_account(login,name,password) values ('user','客服A','user');

INSERT INTO shop_category (type,hot,aid) VALUES ('男士休闲',true,1);
INSERT INTO shop_category (type,hot,aid) VALUES ('女士休闲',true,1);
INSERT INTO shop_category (type,hot,aid) VALUES ('儿童休闲',true,2);
INSERT INTO shop_category (type,hot,aid) VALUES ('老人休闲',false,2);


/* 商品测试用例 */
INSERT INTO shop_product (name,price,picture,remark,xremark,commend,open,cid) VALUES 
...
/* 用户测试用例 */
INSERT INTO shop_user (login,name,password,sex,phone,email)
...
/*插入状态测试用例*/
INSERT INTO shop_status (status) VALUES ('未支付');
INSERT INTO shop_status (status) VALUES ('已支付');
INSERT INTO shop_status (status) VALUES ('配送中');
INSERT INTO shop_status (status) VALUES ('订单完成');
